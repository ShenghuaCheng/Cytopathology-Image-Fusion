import numpy as np
import cv2
from compare_fusion.guided_filter.smooth import box_filter
from compare_fusion.guided_filter.image import to_32F
...
def guided_filter(image , radius = 8 , eps = 0.2 ** 2):
