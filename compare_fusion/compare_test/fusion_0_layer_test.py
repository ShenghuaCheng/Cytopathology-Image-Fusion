...
if __name__ == '__main__':
    ...
    # set test model path
    unet_catblur_patch64_model_path = r'D:\20x_and_40x_data\train_log\our_blur_0_layer_continue\checkpoints\netG_epoch_12_6156.pth'
    unet_patch64_model_path = r'X:\GXB\20x_and_40x_data\test_result\compares_new\gen_0_fusion\netG_epoch_10_5244.pth'
    ...
    layers = [0]
    #  只读取 100 张进行测试
    imgs , names = read_data(path , layers , k = 150)
    ...
    # unet_patch64_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\compares_new\\gen_0_fusion\\our_no_BM\\'
    # if not os.path.exists(unet_patch64_path):
    #     os.makedirs(unet_patch64_path)
    ...
    unet_patch64_catblur_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\compares_new\\temp\\our_BM_12_6156\\'
    if not os.path.exists(unet_patch64_catblur_path):
        os.makedirs(unet_patch64_catblur_path)
