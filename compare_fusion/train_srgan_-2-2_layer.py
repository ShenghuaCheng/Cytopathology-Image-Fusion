...
checkpoints_path = path + 'checkpoints/srgan_fusion_-2-2_layer/'
image_log_path = path + 'image_log/srgan_fusion_-2-2_layer/'
tensorboard_log = path + 'run_log/srgan_fusion_-2-2_layer/'
# model_save_step = 500
img_log_step = 50
lr = 1e-4
