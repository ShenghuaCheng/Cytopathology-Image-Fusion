import os
import torch
from model.model import LightR
...
def test_models():
    layers = [-1, 0, 1]
    dtcwt_fusion_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\multi_img_fusion_test_img\\dtcwt_fusion_30_imgs\\-1-1\\'
    ...
    model_path = 'V:\\fusion_0_-1_1_unet\\checkpoints\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-1-1_layers_models\\'
    test_list = ['netG_epoch_6_2118.pth', 'netG_epoch_6_2136.pth', 'netG_epoch_6_2140.pth', 'netG_epoch_6_2152.pth',
                 'netG_epoch_6_2167.pth']

    if not os.path.exists(result_path):
        os.makedirs(result_path)

    log_file = open(result_path + 'fusion_-1-1_layers_models.txt' , 'w')
...
def test_imgs():
    ...
    model_path = 'V:\\fusion_0_-1_1_unet\\checkpoints\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-1-1_layers_imgs\\'
    test_list = ['netG_epoch_6_2118.pth']
