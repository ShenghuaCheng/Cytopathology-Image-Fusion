...
def test_models():
    layers = [-2 , -1, 0, 1 , 2]
    dtcwt_fusion_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\multi_img_fusion_test_img\\dtcwt_fusion_30_imgs\\-2-2\\'
    ...
    model_path = 'V:\\fusion_-2-2_unet\\checkpoints\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-2-2_layers_models\\'
    test_list = ['netG_epoch_8_5958.pth','netG_epoch_8_5956.pth' , 'netG_epoch_8_5953.pth','netG_epoch_8_5952.pth','netG_epoch_8_5950.pth']

    if not os.path.exists(result_path):
        os.makedirs(result_path)

    log_file = open(result_path + 'fusion_-2-2_layers_models.txt' , 'w')
...
def test_imgs():
    ...
    model_path = 'V:\\fusion_-2-2_unet\\checkpoints\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-2-2_layers_imgs\\'
    test_list = ['netG_epoch_8_5958.pth']
