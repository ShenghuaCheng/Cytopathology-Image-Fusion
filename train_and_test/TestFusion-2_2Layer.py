import os
import torch
from model.model import SingleLayerGenerator
...
def get_item(layers , img_name , data_path , label_path):
    img20x_data = []
    if layers == [-2 , 2]:
        layers = [layers[random.randint(0 , 1)]]
    for layer in layers:
...
def test_model_mean():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_-2_2_srgan15\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-2_2_15sr_layer_multi_models\\'
    test_list = ['netG_epoch_5_3697.pth', 'netG_epoch_5_3621.pth', 'netG_epoch_5_3717.pth', 'netG_epoch_5_3297.pth',
                 'netG_epoch_5_3423.pth']

    log_writer = SummaryWriter(result_path + 'fusion_-2_2_layer_patch_multi_models.log')
    log_file = open(result_path + 'fusion_-2_2_layer_patch_multi_models.txt' , 'w')

    model_g = SingleLayerGenerator(15)
...
def test_model():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_-2_2_srgan15\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_-2_2_15sr_layer_multi_imgs\\'
    test_list = ['netG_epoch_5_3697.pth']

    log_writer = SummaryWriter(result_path + 'fusion_-2_2_layer_patch_multi_imgs.log')
    log_file = open(result_path + 'fusion_-2_2_layer_patch_multi_imgs.txt' , 'w')
