...
def test_model_mean():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_0_layer\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_0_layer_multi_models\\'
    test_list = ['netG_epoch_8_5883.pth', 'netG_epoch_8_5873.pth', 'netG_epoch_8_5854.pth', 'netG_epoch_8_5839.pth',
                 'netG_epoch_8_5807.pth']

    log_writer = SummaryWriter(result_path + 'fusion_0_layer_multi_models.log')
    log_file = open(result_path + 'fusion_0_layer_multi_models.txt' , 'w')
...
def test_model():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_0_layer\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_0_layer_multi_imgs\\'
    test_list = ['netG_epoch_8_5883.pth']
        # , 'netG_epoch_4_3703.pth', 'netG_epoch_4_3696.pth', 'netG_epoch_4_3690.pth',
        #          'netG_epoch_4_3684.pth']

    log_writer = SummaryWriter(result_path + 'fusion_0_layer_multi_imgs.log')
    log_file = open(result_path + 'fusion_0_layer_multi_imgs.txt' , 'w')
