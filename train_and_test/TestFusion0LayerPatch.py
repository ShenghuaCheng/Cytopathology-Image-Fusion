...
def test_model_mean():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_0_layer_patch\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_0_layer_patch_multi_models\\'
    test_list = ['netG_epoch_7_4858.pth', 'netG_epoch_7_4829.pth', 'netG_epoch_7_4816.pth', 'netG_epoch_7_4815.pth',
                 'netG_epoch_7_4893.pth']

    log_writer = SummaryWriter(result_path + 'fusion_0_layer_patch_multi_models.log')
    log_file = open(result_path + 'fusion_0_layer_patch_multi_models.txt' , 'w')
...
def test_model():
    ...
    model_path = 'X:\\GXB\\20x_and_40x_data\\checkpoints\\fusion_0_layer_patch\\'
    result_path = 'X:\\GXB\\20x_and_40x_data\\test_result\\fusion_0_layer_patch_multi_imgs\\'
    test_list = ['netG_epoch_7_4858.pth']
        # , 'netG_epoch_4_3703.pth', 'netG_epoch_4_3696.pth', 'netG_epoch_4_3690.pth',
        #          'netG_epoch_4_3684.pth']

    log_writer = SummaryWriter(result_path + 'fusion_0_layer_patch_multi_imgs.log')
    log_file = open(result_path + 'fusion_0_layer_patch_multi_imgs.txt' , 'w')
