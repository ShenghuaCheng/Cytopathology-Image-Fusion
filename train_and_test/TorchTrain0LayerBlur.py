...
checkpoints_path = path + 'checkpoints/fusion_0_layer_c/'
image_log_path = path + 'image_log/fusion_0_layer_c/'
tensorboard_log = path + 'run_log/fusion_0_layer_c/'
# model_save_step = 500
img_log_step = 50
...
pretrain_flag = True
if pretrain_flag:
    netG.load_state_dict(torch.load(checkpoints_path + 'netG_epoch_%d_%d.pth' % (1 , 267)))
    netD1.load_state_dict(torch.load(checkpoints_path + 'netD1_epoch_%d_%d.pth' % (1 , 267)))
# set optimizer
